...
export type TokenSymbol = "USDC" | "USDC";
...
export const CAMPAIGNS: Campaign[] = [
  // --- ACTIVE CAMPAIGNS ---
  {
    ...
    tagline: "Teaching Solidity and Stellar development to 10,000 developers worldwide.",
    description: "We are building the next generation of Stellar builders. The learning curve for Web3 development is too steep for most developers in Africa and beyond.",
    category: "Education",
    projectStage: "MVP",
    location: "Global",
    raised: 12000,
    ...
    creatorBio: "Ex-educators and early Stellar adopters.",
    twitter: "@StellarSchool",
    github: "github.com/stellarschool",
    portfolio: "stellarschool.com",
    videoUrl: "",
  ...
  },
  {
    ...
    description: "Enabling millions of MiniPay users across West Africa to buy and sell goods using USDC — no bank account required.",
  ...
  },
  {
    id: "stellar-gaming",
    title: "Savannaverse",
    tagline: "An MMORPG where every item is a Stellar NFT.",
    description: "Play, earn, and own your assets on Stellar. Built mobile-first for MiniPay users.",
    category: "Gaming",
    projectStage: "Idea",
    ...
    creator: "SavannaLabs",
    creatorImage: "https://github.com/shadcn.png",
    creatorBio: "Game devs making the jump to Web3 on Stellar.",
    twitter: "@SavannaLabs",
    github: "",
    portfolio: "",
    videoUrl: "",
  ...
  {
    id: "stellar-dex",
    title: "Zero-Fee DEX on Stellar",
    tagline: "Swap USDC and USDC with zero protocol fees.",
    description: "A community-owned automated market maker on Stellar prioritizing deep stablecoin liquidity and zero rent-seeking.",
    category: "DeFi",
    ...
    creator: "DEX DAO",
    creatorImage: "https://github.com/shadcn.png",
    creatorBio: "DeFi maximalists building on Stellar.",
    twitter: "@ZeroFeeDex",
    github: "",
    portfolio: "",
    videoUrl: "",
  ...
  // --- SUCCESSFUL CAMPAIGNS ---
  {
    ...
    tagline: "The first mobile-first yield aggregator on Stellar.",
    description: "Democratizing finance for the 99% with simple UX and trustless strategies built on Stellar.",
    category: "DeFi",
    projectStage: "Prototype",
    location: "Lagos, Nigeria",
    raised: 55000,
  ...
  },
  {
    id: "stellar-ops",
    title: "Stellar Ops",
    tagline: "Decentralized dev-ops tooling for Stellar smart contracts.",
    description: "Automate your Stellar deployments with 100% uptime.",
  ...
  // --- FAILED CAMPAIGNS ---
  {
    id: "green-mining",
    title: "Green Mining",
    tagline: "Solar-powered Stellar validator node initiative.",
    description: "Carbon neutral Stellar validation ensuring the future of sustainable proof-of-stake.",
    category: "Infrastructure",
    projectStage: "Idea",
    location: "Austin, TX",
    raised: 5000,
  ...
  },
  {
    ...
    tagline: "10,000 on-chain pixel warriors on Stellar.",
    description: "A generative art project aiming to build a metaverse on Stellar.",
    category: "Gaming",
    projectStage: "Idea",
    location: "Remote",
    raised: 1200,
