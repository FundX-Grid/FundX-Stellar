      ...
      <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
         ...
         <div className="space-y-6">
            <div className="space-y-2">
               ...
               <Input placeholder="e.g. Stellar DeFi Academy" className="h-14 rounded-xl text-lg font-bold" value={formData.title} onChange={(e) => setFormData({...formData, title: e.target.value})} />
            </div>
    ...
    return (
      <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
         ...
         <div className="space-y-2 mb-6">
            ...
            <Select onValueChange={(val) => setFormData({...formData, currency: val as "USDC" | "USDC"})} defaultValue={formData.currency}>
