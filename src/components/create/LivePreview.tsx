  ...
  return (
    <div className="sticky top-32 space-y-6">
        <div className="text-center">
            <p className="text-sm font-bold_ text-slate-400 uppercase tracking-widest mb-4">Live Preview</p>
        </div>
        ...
        <div className="bg-white/50 backdrop-blur border border-slate-200 p-4 rounded-xl text-sm space-y-2 max-w-[320px] mx-auto mt-4">
            <p className="font-bold_ text-slate-900">Metadata Preview:</p>
            ...
            <div className="flex items-center gap-2 text-slate-500">
                ...
                <span className={`font-bold_ px-2 py-0.5 rounded-md text-xs ${isCUSD ? 'bg-green-100 text-green-600' : 'bg-blue-50 text-blue-600'}`}>
