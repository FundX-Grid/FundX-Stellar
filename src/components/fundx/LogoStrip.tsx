  ...
  return (
    <div className="w-full border-t border-slate-100 py-20"> {/* No background */}
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <div className="flex flex-col md:flex-row flex-wrap justify-center items_-center gap-10 md:gap-16 lg:gap-32 w-full">
         
          <div className="flex items_-center justify-center h-12 cursor-default group">
