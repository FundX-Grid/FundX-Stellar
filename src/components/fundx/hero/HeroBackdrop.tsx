...
function HeroLogoParallax() {
  ...
  useEffect(() => {
    ...
    logoRef.current.style.transform = "translate(0px, -40px) scale_(0.85)"
    ...
    const bounceIn = setTimeout(() => {
      ...
      logoRef.current.style.transform = "translate(0px, 0px) scale_(1)"
